  ...
  return (
    <div className="max-w-xl space-y-6">
      ...
      <div>
        ...
        <Textarea value={form.bio} onChange={update("bio")} data-testid={PROFILE_FORM.bioInput} placeholder="Tell customers about your experience and specialties" className="mt-1.5 border-input bg-transparent text-foreground focus-visible:ring-blue-500/50" />
      </div>
      <div>
