...
export default function Landing() {
  ...
  return (
    <div className="bg-[#0A0A0A]">
      <section className="relative overflow-hidden px-4 pt-16 pb-24 md:px-8 md:pt-24">
        ...
        <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-12 lg:grid-cols-12">
          ...
          >
            ...
            <h1 className="mt-6 font-heading text-4xl font-light leading-none tracking-tight text-white sm:text-5xl lg:text-6xl">
            ...
            <form onSubmit={handleSearch} className="mt-8 flex max-w-lg items-center gap-2 rounded-2xl border border-white/10 bg-white/[0.03] p-2 backdrop-blur-xl">
            ...
            <div className="mt-10 flex flex-wrap gap-8">
              <div>
                <p className="font-heading text-2xl font-semibold text-white">4.9<span className="text-sm text-zinc-500">/5</span></p>
                <p className="text-xs text-zinc-500">Average rating</p>
              </div>
              <div>
                <p className="font-heading text-2xl font-semibold text-white">10</p>
                <p className="text-xs text-zinc-500">Service categories</p>
              </div>
              <div>
                <p className="font-heading text-2xl font-semibold text-white">24/7</p>
                <p className="text-xs text-zinc-500">Booking support</p>
              </div>
            </div>
          </motion.div>
      ...
      <section className="px-4 py-20 md:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 flex items-end justify-between">
            <div>
              <h2 className="font-heading text-2xl font-medium tracking-tight text-white sm:text-3xl">Browse by category</h2>
              <p className="mt-1 text-sm text-zinc-500">Everything your home needs, from one platform.</p>
            </div>
            ...
            {CATEGORIES.map((cat, i) => (
              ...
              >
                <Link
                  ...
                  className="group relative flex h-36 flex-col justify-between overflow-hidden rounded-2xl border border-white/10 bg-[#1C1C22] p-4 transition-transform hover:-translate-y-1"
                >
      ...
      <section className="px-4 py-20 md:px-8">
        <div className="mx-auto max-w-7xl rounded-3xl border border-white/10 bg-[#12121A] p-8 md:p-14">
          <h2 className="font-heading text-2xl font-medium tracking-tight text-white sm:text-3xl">How QuickFix works</h2>
          <div className="mt-10 grid gap-8 sm:grid-cols-3">
            {STEPS.map((step, i) => (
              ...
              >
                ...
                <h3 className="mt-3 font-heading text-lg font-medium text-white">{step.title}</h3>
        ...
        <div className="mx-auto grid max-w-7xl gap-6 sm:grid-cols-3">
          {[
            ...
            <div key={item.title} className="rounded-2xl border border-white/10 bg-white/[0.02] p-6">
              ...
              <h3 className="mt-4 font-heading text-base font-medium text-white">{item.title}</h3>
      ...
      <section className="px-4 py-20 md:px-8">
        <div className="mx-auto max-w-4xl rounded-3xl border border-white/10 bg-gradient-to-br from-blue-500/10 to-transparent p-10 text-center md:p-16">
          <h2 className="font-heading text-3xl font-medium tracking-tight text-white">Ready to get things fixed?</h2>
          <p className="mt-3 text-sm text-zinc-400">Join thousands of homeowners booking trusted local pros every week.</p>
          <Link
            to="/register"
